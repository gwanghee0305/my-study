...
-- 트리거 동작 확인 => 이벤트를 발생(EMPLOYEE 테이블에 데이터 추가)
INSERT INTO EMPLOYEE (EMP_ID, EMP_NAME, EMP_NO, JOB_CODE, HIRE_DATE)
         VALUES (SEQ_ENO.NEXTVAL, '임광희', '061002-1000000', 'J5', SYSDATE);
...
CREATE TABLE TB_PRODUCT (
        PNO NUMBER PRIMARY KEY,          -- 상품번호 입력
...
ROLLBACK;
--> 매번 유사한 작업을 하나하나 해야하고, 또 실수가 발생되면 롤백 후 다시 실행해야함
-----------------------------------------------------------------------------
/*
    * 트리거 설계(작업 내용 정리)
    TB_PDETAIL(입출고내역) 테이블에 데이터가 1건 추가될 때마다
